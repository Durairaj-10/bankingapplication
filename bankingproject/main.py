...
class BankAccount:
    ...
    def deposit(self, amount):
        try:
            if amount > 0:
                ...
                print(f"Deposit ${amount} into account {self.account_number}. Now Balance: ${self.balance}")
            else:
    ...
    def withdraw(self, amount):
        try:
            if 0 < amount <= self.balance:
                ...
                print(f"Withdrawal ${amount} from account {self.account_number}. Now Balance: ${self.balance}")
            else:
    ...
    def load_accounts(self, filename="accounts.json"):
        try:
            ...
            print("Error reading the file. The file may be corrupted.")
        except Exception as e:
...
def main():
    bank = BankAccount('', '')  # Dummy instance for static methods
